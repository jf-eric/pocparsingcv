...
public class CVTextExtractor {
    ...
    public static String extractTextFromPPT(InputStream inputStream) throws IOException {
        StringBuilder text = new StringBuilder();
    ...
    public static String extractTextFromODT(InputStream inputStream) throws Exception {
